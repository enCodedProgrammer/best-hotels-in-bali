...
export const BOTS: Record<BotId, {name: string; job: string; color: string; soft: string}> = {
	scout: {name: 'Scout', job: 'Finds new listings', color: '#0F6B66', soft: '#D8EBE7'},
	pin: {name: 'Pin', job: 'Finds the exact location', color: '#3C77B0', soft: '#DCE8F4'},
	concierge: {name: 'Concierge', job: 'Handles messages & leads', color: '#C4573D', soft: '#F8DFD7'},
	quill: {name: 'Quill', job: 'Builds & posts listings', color: '#8466B3', soft: '#E9E1F4'},
